...
import StyledCtsCtsTestTextWrapper from './styles';
...
function CtsCtsTestText(props: CtsCtsTestTextProps) {
  ...
  if (displayMode === 'LABELS_LEFT' || displayMode === 'DISPLAY_ONLY') {
    ...
    return displayMode === 'DISPLAY_ONLY' ? (
      <StyledCtsCtsTestTextWrapper> {displayComp} </StyledCtsCtsTestTextWrapper>
    ) : (
      <StyledCtsCtsTestTextWrapper>
        <FieldValueList
...
export default withConfiguration(CtsCtsTestText);
