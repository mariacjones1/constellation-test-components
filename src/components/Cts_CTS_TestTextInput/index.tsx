...
import StyledCtsCtsTestTextInputWrapper from './styles';
...
function CtsCtsTestTextInput(props: CtsCtsTestTextInputProps) {
  const {
    getPConnect,
    placeholder,
    validatemessage,
  ...
  if (displayMode === 'LABELS_LEFT' || displayMode === 'DISPLAY_ONLY') {
    ...
    return displayMode === 'DISPLAY_ONLY' ? (
      <StyledCtsCtsTestTextInputWrapper> {displayComp} </StyledCtsCtsTestTextInputWrapper>
    ) : (
      <StyledCtsCtsTestTextInputWrapper>
        <FieldValueList
...
export default withConfiguration(CtsCtsTestTextInput);
