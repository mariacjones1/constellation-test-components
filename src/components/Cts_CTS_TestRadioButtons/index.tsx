...
import StyledCtsCtsTestRadioButtonsWrapper from './styles';


// interface for props
interface CtsCtsTestRadioButtonsProps extends PConnFieldProps {
...
function CtsCtsTestRadioButtons(props: CtsCtsTestRadioButtonsProps) {
  const {
    getPConnect,
    value,
    label,
  ...
  return (
    <StyledCtsCtsTestRadioButtonsWrapper>
    <RadioButtonGroup
      {...additionalProps}
      label={label}
...
export default withConfiguration(CtsCtsTestRadioButtons);
