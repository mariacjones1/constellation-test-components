...
import StyledCtsCtsTestBooleanWrapper from './styles';

// interface for props
interface CtsCtsTestBooleanProps extends PConnFieldProps {
...
function CtsCtsTestBoolean(props: CtsCtsTestBooleanProps) {
  const {
    getPConnect,
    value = false,
    label = '',
  ...
  if (displayMode === 'DISPLAY_ONLY') {
    return (
      <StyledCtsCtsTestBooleanWrapper>
       {displayComponent}
      </StyledCtsCtsTestBooleanWrapper>
    );
  }
...
export default withConfiguration(CtsCtsTestBoolean);
